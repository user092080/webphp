...
<body>
    ...
    <form method="post" action="">
        ...
        <p class="login-link">Already have an account? <a href="21index.php">Login</a></p>
    </form>
    ...
    if (isset($_POST['submit'])) {
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            echo '<script>alert("Registration completed successfully"); window.location.href = "21index.php";</script>';
            exit();
        } else {
